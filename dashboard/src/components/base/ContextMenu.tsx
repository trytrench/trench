...
//           // light
//           "hover:bg-tremor-background-muted  hover:text-tremor-content-strong ui-selected:text-tremor-content-strong ui-selected:bg-tremor-background-muted text-tremor-content-emphasis",
//           // dark
//           "dark:hover:bg-dark-tremor-background-muted  dark:hover:text-dark-tremor-content-strong dark:ui-selected:text-dark-tremor-content-strong dark:ui-selected:bg-dark-tremor-background-muted dark:text-dark-tremor-content-emphasis",
//           "p-2.5"
//         )}
//       >
//         lmao
